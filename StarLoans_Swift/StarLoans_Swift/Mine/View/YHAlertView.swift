...
class YHAlertView : UIView{
    ...
    private let _contentWidth:CGFloat  = kScreenWidth - 108
    ...
    override init(frame: CGRect) {
        ...
        _labelTitle.textColor = UIColor.RGB(with: 102, green: 102, blue: 102)
        ...
        _labelMessage.textColor = UIColor.RGB(with: 102, green: 102, blue: 102)
    ...
    //图片创建
    init(title:String,message:String?,delegate:YHAlertViewDelegate?){
    ...
    private func _setupButton(){
        ...
        cancelButton.setImage(#imageLiteral(resourceName: "ICON-wentiguanbi"), for: .normal)
        cancelButton.addTarget(target, action: #selector(_clickCancel(sender:)), for: .touchUpInside)
...
//                })
//                cancelButton.setImage(#imageLiteral(resourceName: "ICON-wentiguanbi"), for: .normal)
////                cancelButton.setBackgroundImage(#imageLiteral(resourceName: "ICON-wentiguanbi"), for: .normal)
//                cancelButton.addTarget(target, action: #selector(_clickCancel(sender:)), for: .touchUpInside)
//                let height = _contentHeight/2 + buttonY
//                _contentView.frame = CGRect(x: 0, y: 0, width: _contentWidth, height: height)
//                _contentView.center = self.center
