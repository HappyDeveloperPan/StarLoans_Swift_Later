...
//    var viewController: UICollectionGridViewController!
    ...
    override func prepare() {
        ...
        if itemsSize.count != (collectionView as! GridView).cols.count {
            calculateItemsSize()
        }
        ...
        for section in 0 ..< (collectionView?.numberOfSections)! {
            ...
            for index in 0 ..< (collectionView as! GridView).cols.count {
                ...
                if column == (collectionView as! GridView).cols.count {
    ...
    func calculateItemsSize() {
        ...
        var index = (collectionView as! GridView).cols.count - 1
        while index >= 0 {
    ...
    func sizeForItemWithColumnIndex(columnIndex: Int, remainingWidth: CGFloat) -> CGSize {
        let columnString = (collectionView as! GridView).cols[columnIndex]
        //根据列头标题文件，估算各列的宽度
