...
//MARK:---用来计算出rect这个范围内所有cell的UICollectionViewLayoutAttributes，
    override func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
       //根据当前滚动进行对每个cell进行缩放
        ...
        let array = super.layoutAttributesForElements(in: rect) /* copyItems: true */
        let newArray:[UICollectionViewLayoutAttributes] = NSArray(array: array!, copyItems:true)as! [UICollectionViewLayoutAttributes]
