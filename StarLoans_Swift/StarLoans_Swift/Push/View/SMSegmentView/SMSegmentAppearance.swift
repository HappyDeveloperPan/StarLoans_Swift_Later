...
open class SMSegmentAppearance {
    ...
    open var bottomLineOnSelectColor: UIColor
    open var bottomLineOffSelectColor: UIColor
    ...
    public init() {
        ...
        self.bottomLineOnSelectColor = UIColor(red: 242/255, green: 56/255, blue: 61/255, alpha: 1)
        self.bottomLineOffSelectColor = UIColor.white
    ...
    public init(contentVerticalMargin: CGFloat, segmentOnSelectionColour: UIColor, segmentOffSelectionColour: UIColor, titleOnSelectionColour: UIColor, titleOffSelectionColour: UIColor, titleOnSelectionFont: UIFont, titleOffSelectionFont: UIFont, titleGravity: SMSTitleGravity?, bottomLineOnSelectColor: UIColor?) {
        ...
        if let OnSelectColor = bottomLineOnSelectColor {
            self.bottomLineOnSelectColor = OnSelectColor
        }else {
            self.bottomLineOnSelectColor = UIColor(red: 242/255, green: 56/255, blue: 61/255, alpha: 1)
        }
